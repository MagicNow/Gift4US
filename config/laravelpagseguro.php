...
return [
    ...
    'credentials' => [//INFORME AS CREDENCIAIS PADRÕES DE SUA LOJA, MAS PORDERÁ SER ALTERADA EM RUNTIME
        ...
        'token' => '76FE129FAF444756BE447FF9A9B10943',
    ],
    ...
    'routes' => [
        'redirect' => [
            'route-name' => 'convidado.roupas.sucesso', // Criar uma rota com este nome
        ],
        'notification' => [
            ...
            'route-name' => 'presentes.pagamento', // Criar uma rota com este nome
        ],
    ],
