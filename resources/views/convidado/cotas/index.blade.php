						...
						@if (isset($products) && count($products) > 0)
							@foreach ($products as $cota)
								<li class="col-md-6 gifts-item " data-id="24">
									<div class="row">
										<div class="col-md-5">
											<a href="{{ route('convidado.cotas.detalhe', [ $party->slug, $cota->id]) }}" target="_self"><img src="{{ url('storage/quotas/' . $cota->foto) }}" class="gifts-item-image" width="100%"></a>
										</div>
									...
									<div class="gifts-item-buttons">
										<a href="{{ route('convidado.cotas.detalhe', [ $party->slug, $cota->id]) }}" class="col-md-7 col-md-offset-5 gifts-item-button gifts-item-button-show-cota">Ver detalhes</a>
									</div>
								</li>
							@endforeach
						@endif
