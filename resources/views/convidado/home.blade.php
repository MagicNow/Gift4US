...
@section('content')
	...
	<div class="preview dashboard col-xs-12 col-sm-12 col-md-12 col-lg-12 {{ $party->layout()->first()->class }}">
		<img src="{{ url('assets/site/images/presentinho-preview-1.png') }}" class="preview-presentinho">

		<a href="{{ route('usuario.meus-aniversarios.novo.festa', [ $party->id, 4]) }}" class="btn-blue preview-back-btn">VOLTAR PARA ESCOLHA DE LAYOUT</a>
