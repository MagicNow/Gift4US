							...
							<div class="row">
								<div class="col-md-7 form-birthday-size-column">
									...
									<div class="form-group form-birthday-size-container">
										...
										<input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" size=2 maxlength=2 name="tamanho_sapato" placeholder="Digite o tamanho" class="form-control form-usuario-sap form-birthday-size-input {{ $errors->first('tamanho_sapato', 'has-error') }}" id="aniver-tamanho-sapato" value="{{ $festa->tamanho_sapato }}">
