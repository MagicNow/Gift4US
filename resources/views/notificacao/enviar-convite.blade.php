					...
					<div class="enviar-convite">
						<div class="row enviar-convite-secao">
							<div class="col-md-7">
								...
								<span class="enviar-convite-texto" id="convite-url">{{ route('convidado.index', $party->codigo) }}</span>
								<div class="row">
						...
						<div class="row compartilhe enviar-convite-secao">
							<div class="col-md-6 enviar-convite-coluna">
								...
								<div class="row">
									<a href="https://www.facebook.com/sharer/sharer.php?u={{ route('convidado.index', $party->codigo) }}" target="_blank" class="col-md-12 enviar-convite-button"><span class="button">Compartilhar<br>no perfil</span></a>
								</div>
							</div>
							<div class="col-md-6 enviar-convite-coluna">
								<h5 class="whatsapp">Compartilhar no Whatsapp</h5>
								<div class="row">
									<a href="whatsapp://send?text={{ url(Storage::url('public/birthdays/invites/' . $party->codigo . '.jpg')) }}" class="col-md-6 enviar-convite-button"><span class="button">Compartilhar convite</span></a>
									<a href="whatsapp://send?text={{ route('convidado.index', $party->codigo) }}" class="col-md-6 enviar-convite-button"><span class="button">Compartilhar <br>link da página</span></a>
								</div>
							</div>
						</div>
						<div class="row compartilhe enviar-convite-secao">
							...
							<div class="col-md-6 enviar-convite-coluna">
								...
								<div class="row text-center">
									@if (Storage::exists('public/birthdays/invites/' . $party->codigo . '.jpg'))
										...
										<a href="{{ Storage::url('public/birthdays/invites/' . $party->codigo . '.jpg') }}" target="_blank" download class="enviar-convite-button col-md-12"><span class="button">Baixar</span></a>
									@endif
								</div>
							</div>
						</div>
