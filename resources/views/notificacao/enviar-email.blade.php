				...
				<div class="col-md-8 dados-container">
					...
					<div class="lista-email">
						...
						<fieldset class="col-md-12">
							<input class="texto col-md-8" type="text" value="escreva aqui o e-mail do convidado" />
							<button class="col-md-4" type="button">Adicionar</button>
						</fieldset>
						<fieldset class="col-md-12">
						...
						<fieldset class="border col-md-12">
							...
							<button class="col-md-4" type="button">Upload .txt</button>
						</fieldset>
						<ul class="col-md-12">
							<li><a href="#">Excluir</a> email@email.com.br</li>
							<li><a href="#">Excluir</a> email@email.com.br</li>
							<li><a href="#">Excluir</a> email@email.com.br</li>
							<li><a href="#">Excluir</a> email@email.com.br</li>
							<li><a href="#">Excluir</a> email@email.com.br</li>
						...
						<fieldset class="bottom col-md-12">
							<div>
								<label class="col-md-12">10 emails cadastrados</label>
